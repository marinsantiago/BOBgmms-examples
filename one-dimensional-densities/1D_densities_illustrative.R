# ------------------------------------------------------------------------------
# One-dimensional density plots: Illustrative simulation experiment
# ------------------------------------------------------------------------------

folder <- "simulations/sim-illustrative"
...
d <- ncol(bayes.pred)
var.names <- paste0("Feature ", seq_len(d), sep = "")

ylims <- list(
  c(0, 0.25), c(0, 0.25), c(0, 0.25), c(0, 0.25), c(0, 0.25),
  c(0, 0.25), c(0, 0.30), c(0, 0.25), c(0, 0.25), c(0, 0.70),
  c(0, 0.70), c(0, 0.70), c(0, 0.70), c(0, 0.70), c(0, 0.70)
)
