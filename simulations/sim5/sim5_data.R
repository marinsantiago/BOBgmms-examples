...
dataSim5 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim5[[i]] <- iteration_i
  
}

names(dataSim5) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim5, file = "simulations/sim5/dataSim5.Rdata")
