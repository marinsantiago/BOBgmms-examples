# ------------------------------------------------------------------------------
# Sim setting 5: Generate the data
# ------------------------------------------------------------------------------
...
data_setting5 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting5[[sim]] <- iteration_i
}

names(data_setting5) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting5/data_setting5.Rdata"
save(data_setting5, file = folder_path)
