# ------------------------------------------------------------------------------
# Sim setting 2: Generate the data
# ------------------------------------------------------------------------------
...
data_setting2 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting2[[sim]] <- iteration_i
}

names(data_setting2) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting2/data_setting2.Rdata"
save(data_setting2, file = folder_path)
