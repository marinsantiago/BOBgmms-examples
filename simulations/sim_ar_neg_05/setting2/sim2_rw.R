# ------------------------------------------------------------------------------
# Sim setting 2: Random weighting
# ------------------------------------------------------------------------------
...
wbb1_setting2 <- vector("list", total_sims)
wbb2_setting2 <- vector("list", total_sims)
bob_setting2 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  wbb1_setting2[[sim]] <- results.wbb1
  wbb2_setting2[[sim]] <- results.wbb2
  bob_setting2[[sim]] <- results.bob
...
names(wbb1_setting2) <- paste0("rep", seq_len(total_sims))
names(wbb2_setting2) <- paste0("rep", seq_len(total_sims))
names(bob_setting2) <- paste0("rep", seq_len(total_sims))

# Export the RW results
folder_path <- "simulations/sim_ar_neg_05/setting2"
save(wbb1_setting2, file = paste(folder_path, "/wbb1_sim2.Rdata", sep = ""))
save(wbb2_setting2, file = paste(folder_path, "/wbb2_sim2.Rdata", sep = ""))
save(bob_setting2, file = paste(folder_path, "/bob_sim2.Rdata", sep = ""))
