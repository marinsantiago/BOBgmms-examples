# ------------------------------------------------------------------------------
# Sim setting 6: Generate the data
# ------------------------------------------------------------------------------
...
data_setting6 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting6[[sim]] <- iteration_i
}

names(data_setting6) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting6/data_setting6.Rdata"
save(data_setting6, file = folder_path)
