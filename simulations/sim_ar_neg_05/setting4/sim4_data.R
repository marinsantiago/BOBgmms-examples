# ------------------------------------------------------------------------------
# Sim setting 4: Generate the data
# ------------------------------------------------------------------------------
...
data_setting4 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting4[[sim]] <- iteration_i
}

names(data_setting4) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting4/data_setting4.Rdata"
save(data_setting4, file = folder_path)
