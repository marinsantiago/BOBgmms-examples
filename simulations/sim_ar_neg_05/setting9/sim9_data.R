# ------------------------------------------------------------------------------
# Sim setting 9: Generate the data
# ------------------------------------------------------------------------------
...
data_setting9 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting9[[sim]] <- iteration_i
}

names(data_setting9) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting9/data_setting9.Rdata"
save(data_setting9, file = folder_path)
