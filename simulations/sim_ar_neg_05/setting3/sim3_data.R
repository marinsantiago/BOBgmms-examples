# ------------------------------------------------------------------------------
# Sim setting 3: Generate the data
# ------------------------------------------------------------------------------
...
data_setting3 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting3[[sim]] <- iteration_i
}

names(data_setting3) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting3/data_setting3.Rdata"
save(data_setting3, file = folder_path)
