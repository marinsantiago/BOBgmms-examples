# ------------------------------------------------------------------------------
# Sim setting 7: Generate the data
# ------------------------------------------------------------------------------
...
data_setting7 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting7[[sim]] <- iteration_i
}

names(data_setting7) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting7/data_setting7.Rdata"
save(data_setting7, file = folder_path)
