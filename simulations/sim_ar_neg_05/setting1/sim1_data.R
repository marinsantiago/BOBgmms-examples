# ------------------------------------------------------------------------------
# Sim setting 1: Generate the data
# ------------------------------------------------------------------------------
...
data_setting1 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  data_setting1[[sim]] <- iteration_i
}

names(data_setting1) <- paste0("rep", seq_len(total_sims))

# Export generated data --------------------------------------------------------
folder_path <- "simulations/sim_ar_neg_05/setting1/data_setting1.Rdata"
save(data_setting1, file = folder_path)
