...
# ------------------------------------------
# Sim1 - Weighted Bayesian Bootstrap
# ------------------------------------------
...
wbb1Sim1 <- vector("list", totalSims)
wbb2Sim1 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  wbb1Sim1[[i]] <- results.wbb1
  wbb2Sim1[[i]] <- results.wbb2

  rm(wbb1.draws, wbb2.draws)
  rm(y.new.wbb1, y.new.wbb2)
}

names(wbb1Sim1) <- paste0("iteration", 1:totalSims)
names(wbb2Sim1) <- paste0("iteration", 1:totalSims)

# Export wbb results
save(wbb1Sim1, file = "simulations/sim1/wbb1Sim1.Rdata")
save(wbb2Sim1, file = "simulations/sim1/wbb2Sim1.Rdata")
