...
dataSim1 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim1[[i]] <- iteration_i
  
}

names(dataSim1) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim1, file = "simulations/sim1/dataSim1.Rdata")
