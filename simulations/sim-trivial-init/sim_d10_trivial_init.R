# ------------------------------------------------------------------------------
# Simulations under a trivial initialization (d = 10)
# ------------------------------------------------------------------------------
...
dists_wbb1_d10 <- dists_wbb2_d10 <- dists_bob_d10 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  # Store the results
  dists_wbb1_d10[[sim]] <- sw2wbb1
  dists_wbb2_d10[[sim]] <- sw2wbb2
  dists_bob_d10[[sim]] <- sw2bob
  
}


results_d10 <- list(
  dist_wbb1 = dists_wbb1_d10,
  dist_wbb2 = dists_wbb2_d10,
  dist_bob = dists_bob_d10
)

# Export the results -----------------------------------------------------------

save(results_d10, file = "simulations/sim-trivial-init/results_d10.Rdata")
