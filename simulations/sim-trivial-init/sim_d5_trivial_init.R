# ------------------------------------------------------------------------------
# Simulations under a trivial initialization (d = 5)
# ------------------------------------------------------------------------------
...
dists_wbb1_d5 <- dists_wbb2_d5 <- dists_bob_d5 <- vector("list", total_sims)
...
for (sim in seq_len(total_sims)) {
  ...
  # Store the results
  dists_wbb1_d5[[sim]] <- sw2wbb1
  dists_wbb2_d5[[sim]] <- sw2wbb2
  dists_bob_d5[[sim]] <- sw2bob
  
}


results_d5 <- list(
  dist_wbb1 = dists_wbb1_d5,
  dist_wbb2 = dists_wbb2_d5,
  dist_bob = dists_bob_d5
)

# Export the results -----------------------------------------------------------

save(results_d5, file = "simulations/sim-trivial-init/results_d5.Rdata")
