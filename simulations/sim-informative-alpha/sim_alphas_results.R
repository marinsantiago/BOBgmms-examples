# ------------------------------------------------------------------------------
# Simulations under an informative Dirichlet prior - Results
# ------------------------------------------------------------------------------

# Load the results -------------------------------------------------------------

load("simulations/sim-informative-alpha/results_d5.Rdata")
load("simulations/sim-informative-alpha/results_d10.Rdata")
load("simulations/sim-informative-alpha/results_d15.Rdata")
