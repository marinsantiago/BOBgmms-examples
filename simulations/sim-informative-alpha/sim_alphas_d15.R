# ------------------------------------------------------------------------------
# Simulations under an informative Dirichlet prior (d = 15)
# ------------------------------------------------------------------------------
...
for (sim in seq_len(total_sims)) {
  ...
  alphas <- rpois(K, 10) + 1.1 # Strong informative priors
...
save(results_d15, file = "simulations/sim-informative-alpha/results_d15.Rdata")
