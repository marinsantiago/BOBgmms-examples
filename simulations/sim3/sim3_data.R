...
dataSim3 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  cat("Init alg:", init.params$algorithm, "\n")
  ...
  dataSim3[[i]] <- iteration_i
  
}

names(dataSim3) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim3, file = "simulations/sim3/dataSim3.Rdata")
