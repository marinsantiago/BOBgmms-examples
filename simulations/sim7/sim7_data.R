...
dataSim7 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim7[[i]] <- iteration_i
  
}

names(dataSim7) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim7, file = "simulations/sim7/dataSim7.Rdata")
