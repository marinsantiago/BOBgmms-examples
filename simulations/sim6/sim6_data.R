...
dataSim6 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim6[[i]] <- iteration_i
  
}

names(dataSim6) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim6, file = "simulations/sim6/dataSim6.Rdata")
