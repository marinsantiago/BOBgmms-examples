...
dataSim2 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim2[[i]] <- iteration_i
  
}

names(dataSim2) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim2, file = "simulations/sim2/dataSim2.Rdata")
