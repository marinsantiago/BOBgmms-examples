...
# ------------------------------------------
# Sim9 - Weighted Bayesian Bootstrap
# ------------------------------------------
...
wbb1Sim9 <- vector("list", totalSims)
wbb2Sim9 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  wbb1Sim9[[i]] <- results.wbb1
  wbb2Sim9[[i]] <- results.wbb2
  
  rm(wbb1.draws, wbb2.draws)
  rm(y.new.wbb1, y.new.wbb2)
}

names(wbb1Sim9) <- paste0("iteration", 1:totalSims)
names(wbb2Sim9) <- paste0("iteration", 1:totalSims)

# Export wbb results
save(wbb1Sim9, file = "simulations/sim9/wbb1Sim9.Rdata")
save(wbb2Sim9, file = "simulations/sim9/wbb2Sim9.Rdata")
