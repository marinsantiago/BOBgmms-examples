...
dataSim9 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim9[[i]] <- iteration_i
  
}

names(dataSim9) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim9, file = "simulations/sim9/dataSim9.Rdata")
