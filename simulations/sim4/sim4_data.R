...
dataSim4 <- vector("list", totalSims)
...
for (i in 1:totalSims) {
  ...
  dataSim4[[i]] <- iteration_i
  
}

names(dataSim4) <- paste0("iteration", 1:totalSims)

# Export generated data
save(dataSim4, file = "simulations/sim4/dataSim4.Rdata")
